...
Haben wir den Betrag einer Zahl $|z| = r$ und das Argument $\arg(z)=\phi$ ist es oft einfacher das Polarkoordinatensystem zu verwenden. $r$ wird hierbei als Kreise dargestellt und die Gitterlinien sind 
## Herleitungen
### Cardanos Problem
$$
\begin{align}
