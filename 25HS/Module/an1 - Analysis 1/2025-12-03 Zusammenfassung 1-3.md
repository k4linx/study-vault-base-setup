...
einen Grenzwert in folgender form $a_{n}= \sqrt{n+1}-\sqrt{n}$ kann mit der [[Rechenregeln, Gleichungen und Funktionen#Binomische Formeln|3. Binomischen ]]Formel erweitert werden um die $n$ unter der wurzel wegheben zu können. 
$$
\begin{align}
