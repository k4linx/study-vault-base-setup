...
##### Messdaten Teil 1
| Frequenz (Hz) | $R_{1} \ [k\ohm]$ | $R_{2} \ [k\ohm]$ | $\frac{R2}{R1}$ | $U_{1} \ [V]$ | $U_{2} \ [V]$ | Verstärkung R2 1k(dB) | $R_{1} \ [k\ohm]$ | $R_{2} \ [k\ohm]$ | $\frac{R2}{R1}$ | $U_{1} \ [V]$ | $U_{2} \ [V]$ | Verstärkung R2 10k(dB) |
| ------------- | ----------------- | ----------------- | --------------- | ------------- | ------------- | --------------------- | ----------------- | ----------------- | --------------- | ------------- | ------------- | ---------------------- |
...
layout: columns
width: 100%
select: [Verstärkung R2 1k(dB), Verstärkung R2 10k(dB)]
xTitle: Frequenz [Hz]
yTitle: Verstärkung [dB]
legend: true
```
