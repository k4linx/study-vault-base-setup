...
| Frequenz (Hz) | $V_{u}=\frac{R2}{R1} = \frac{1k\ohm}{1k\ohm}$ | $U_{1} \ [V]$ | $U_{2} \ [V]$ | Verstärkung R2 1kohm(dB) | $V_{u}=\frac{R2}{R1} = \frac{10k\ohm}{1k\ohm}$ | $U_{1} \ [V]$ | $U_{2} \ [V]$ | Verstärkung R2 10kohm(dB) |
| ------------- | --------------------------------------------- | ------------- | ------------- | ------------------------ | ---------------------------------------------- | ------------- | ------------- | ------------------------- |
